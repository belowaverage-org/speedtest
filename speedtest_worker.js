...
var settings = {
	...
	count_ping: 50, // number of pings to perform in ping test
	url_dl: "garbage.php", // path to a large file or garbage.php, used for download test. must be relative to this js file
	url_ul: "null", // path to an empty file, used for upload test. must be relative to this js file
	url_ping: "null", // path to an empty file, used for ping test. must be relative to this js file
	...
	xhr_multistreamDelay: 0, //how much concurrent requests should be delayed
	...
	garbagePhp_chunkSize: 200, // size of chunks sent by garbage.php (can be different if enable_quirks is active)
